...
export default function CartPage() {
  const [products, setProducts] = useState<Product[]>([
    {
      id: 1,
      image:
        "https://http2.mlstatic.com/D_NQ_NP_871755-MLU74346911353_022024-O.webp",
    ...
    },
    {
      id: 3,
      image:
        "https://m.media-amazon.com/images/I/61lSXM4RsqL._AC_SX569_.jpg",
    ...
    },
    {
      id: 4,
      image:
        "https://m.media-amazon.com/images/I/710sK2W6R3L._AC_SX522_.jpg",
  ...
  // Funções para manipular quantidade e remoção
  ...
  // Cálculo do total com desconto: se quantidade >= 3, utiliza preço com 10% de desconto.
  const total = products.reduce((acc, product) => {
    const unitPrice =
      product.quantity >= 3 ? product.price * 0.9 : product.price;
        ...
        <section className="md:col-span-2 flex flex-col">
          ...
          <footer className="mt-8 flex flex-col md:flex-row md:justify-between items-start md:items-center gap-4">
            ...
            <p className="text-xl font-semibold">
              Total:{" "}
              <span className="text-[#DF9829]">R$ {total.toFixed(2)}</span>
            </p>
          </footer>
        </section>
