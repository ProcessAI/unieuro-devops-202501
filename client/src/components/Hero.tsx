...
const slides = [
  ...
  },
  {
    ...
    imageUrl: 'https://www.pngplay.com/wp-content/uploads/12/Handbag-Transparent-Images.png',
    bgColor: 'bg-green-50',
  },
];
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center flex-col md:flex-row">
            <div className="text-left md:w-1/2">
              ...
              <p className="text-lg mb-6 text-gray-700 whitespace-pre-line">{slide.description}</p>
