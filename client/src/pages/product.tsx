      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              <div className="mb-4">
                <span className="text-2xl font-semibold text-green-400">R$ 799,99</span>
                <span className="ml-2 text-sm line-through text-gray-400">R$ 999,99</span>
              </div>
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-green-400 mt-2">
                Frete: R$ 19,90 – Entrega estimada em 3 dias úteis
              </p>
            </div>
        ...
        <div className="mt-10">
          ...
          <p className="text-lg text-gray-300 leading-relaxed">
            Aqui entra o conteúdo completo e detalhado do produto. Pode ser um texto longo que
            descreva benefícios, especificações técnicas, diferenciais, uso recomendado, etc.
          </p>
